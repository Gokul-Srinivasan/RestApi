...
public class StockController {
    ...
    public Optional<Stock> getbymethod(@PathVariable int productId)
    {
        return ps.getbyid(productId);
    }
    @PutMapping("/stock/{id}")
    public Stock putMethodName(@PathVariable int id, @RequestBody Stock entity) {
        //TODO: process PUT request
        
        return ps.put(id, entity);
    }
